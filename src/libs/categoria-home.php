...
<div class="titolo">
    ...
    <input type="<?php echo $templateParams["categoria"][0]["tipoBottone"] ?>" value="<?php echo $templateParams["categoria"][0]["testoBottone"] ?>" onclick="setCategorie(<?php echo $_GET['idcategoria'] ?>)">
</div>
